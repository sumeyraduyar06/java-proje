...
public class ProgramManagerPanel extends javax.swing.JFrame {  
    ...
    // 1. Yeni ve gelişmiş bir tablo modeli oluşturuyoruz
    javax.swing.table.DefaultTableModel tableModel = new javax.swing.table.DefaultTableModel(
        new Object[][] {}, 
        new String[] {"Trainer", "08.00-10.00", "10.00-12.00", "13.00-15.00", "15.00-17.00"}
    ) {
        @Override
        public boolean isCellEditable(int row, int column) {
            // Sadece saat kutucukları (1, 2, 3, 4) tıklanabilsin, 0. sütun (Trainer) kilitli olsun
            return column != 0;
        }
    ...
    // 2. Satır yüksekliğini artırıyoruz ki "guide" yerleri belli olsun
    jTable1.setRowHeight(30); 

    // 3. Eğitmen listesini çekip ekliyoruz
    ...
    if (trainerList != null && trainerList.length > 0) {
        ...
        System.out.println("Uyarı: " + selectedExercise + " için eğitmen bulunamadı!");
    }
    }
